...
import sys
import projConstants as p_c
sys.path.append(p_c.BASE_DIR_AI_HELPER)
sys.path.append(p_c.BASE_DIR_HELPER)

import numpy as np
import pandas as pd
import os
import wget
#import ..my_modules.helper as h
#from ..my_modules import helper as h
import helper as h
